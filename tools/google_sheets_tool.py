"""
CrewAI tool for Google Sheets operations.
"""
...
class GoogleSheetsAddContactTool(BaseTool):
    """Tool for adding contacts to Google Sheets."""
...
class GoogleSheetsSearchTool(BaseTool):
    """Tool for searching contacts in Google Sheets."""
...
class GoogleSheetsGetContactTool(BaseTool):
    ...
    def _run(self, name: str) -> str:
        """Get contact details from Google Sheets."""
        try:
            sheets = get_sheets_service()
...
class GoogleSheetsUpdateContactTool(BaseTool):
...
class GoogleSheetsStatsTool(BaseTool):
